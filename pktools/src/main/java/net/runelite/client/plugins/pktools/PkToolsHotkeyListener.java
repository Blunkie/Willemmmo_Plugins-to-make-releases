...
import net.runelite.client.plugins.pktools.ScriptCommandPkTools.ScriptCommandFactoryPkTools;
...
public class PkToolsHotkeyListener extends MouseAdapter implements KeyListener
{
	...
	private void addCommands(String command, PkToolsPlugin plugin)
	{
		...
		{
			plugin.commandList.add(ScriptCommandFactoryPkTools.builder(c));
			// ScriptCommandFactoryPkTools.builder(c));
		}
	}
	...
	public void keyPressed(KeyEvent e)
	{
		...
		{
			configManager.setConfiguration("net/runelite/client/plugins/pktools", "autoPrayerSwitcherEnabled", !config.autoPrayerSwitcherEnabled());
		}
